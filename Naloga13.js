 ...
 //   });
    ...
    io.sockets.on("connection", function(socket){
        ...
        socket.on("startKontrolniAlgoritem", function(štKontrolnegaAlg){
          ...
          socket.on("PošljiVrednost", function(vrednost){

           želenaVrednost=vrednost; 
           console.log(vrednost);

        });
        
      socket.on("pošljiPozicijo", function(vrednost){
...
function kontrolniAlgoritem (parametri) {
    ...
    if (parametri.štKontrolnegaAlg == 2) {
        ...
        if (parametri.štKontrolnegaAlg == 3) {
...
function pošljiPozicijo(socket2) {

    socket2.emit("pošljiPozicijo",
